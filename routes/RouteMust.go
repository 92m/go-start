...
import (
	...
	"github.com/92m/go-start/app/Http/Controllers"
	"github.com/92m/go-start/app/Http/Middlewares"
	"github.com/92m/go-start/app/Kit"
...
func RouteMust(route *gin.Engine) {
	...
	// 示例-api_json数据输出
	route.Any("api", Middlewares.HttpCorsApi, Middlewares.HttpLimiter(200), Controllers.Api)
